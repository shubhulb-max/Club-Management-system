...
class MatchAdmin(admin.ModelAdmin):
    list_display = (
        ...
        'status', 'match_type', 'tournament', 'match_format', 'ball_type', 'reporting_time', 'result', 'result_summary'
    )
    search_fields = ('team1__name', 'team2__name', 'external_opponent', 'ground__name')
    list_filter = ('date', 'status', 'match_type', 'tournament', 'result', 'ground', 'ball_type', 'match_format')
